...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 md:space-y-10 p-0 md:p-4 lg:p-8">
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between animate-fadeInUp">
        ...
        <div className="relative">
          ...
          <h1 className="text-2xl md:text-4xl font-bold tracking-tight text-[var(--text-primary)]">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlassCard className="col-span-1 lg:col-span-2 animate-fadeInUp stagger-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[var(--border-color)] px-4 md:px-8 py-4 md:py-6">
            <div>
              <h2 className="text-[18px] md:text-[20px] font-bold text-[var(--text-primary)]">
                Pipeline Vânzări
              </h2>
              <p className="text-[13px] md:text-[14px] text-[var(--text-secondary)] mt-0.5">
                Distribuția tranzacțiilor pe etape
              </p>
            </div>
            {pipeline && pipeline.length > 0 && (
              <div className="sm:text-right">
                <p className="text-[12px] md:text-[13px] font-semibold uppercase tracking-wider text-[var(--text-tertiary)]">Total Pipeline</p>
                <p className="text-[20px] md:text-[24px] font-bold gradient-text mt-0.5">
        ...
        <GlassCard className="col-span-1 flex flex-col animate-fadeInUp stagger-7">
          <div className="border-b border-[var(--border-color)] px-4 md:px-8 py-4 md:py-6">
            <h2 className="text-[18px] md:text-[20px] font-bold text-[var(--text-primary)]">
              Activitate Recentă
            </h2>
            <p className="text-[13px] md:text-[14px] text-[var(--text-secondary)] mt-0.5">
...
function QuickActionButton({
  ...
  return (
    <a
      href={href}
      className={cn(
        'group/btn inline-flex items-center gap-2 md:gap-2.5 rounded-xl px-3.5 md:px-5 py-2.5 md:py-3',
...
function TaskRow({ task }: { task: UpcomingTask }) {
  ...
  return (
    <div
      className={cn(
        'group flex items-center gap-3 md:gap-5 rounded-xl px-3 md:px-5 py-3 md:py-4',
    ...
    >
      <div
        className={cn(
          'hidden sm:flex h-13 w-13 shrink-0 items-center justify-center rounded-xl',
      ...
      <div className="min-w-0 flex-1">
        <p
          className={cn(
            'truncate text-[15px] md:text-[17px] font-medium',
            isOverdue
        ...
        <div className="mt-0.5 hidden sm:flex items-center gap-2 text-[15px] text-[var(--text-tertiary)]">
      ...
      <div className="flex shrink-0 items-center gap-2 md:gap-3">
        <span className="hidden sm:inline"><PriorityBadge priority={task.priority} /></span>
        <span
          className={cn(
            'text-[13px] md:text-[15px] font-semibold whitespace-nowrap',
            isOverdue
